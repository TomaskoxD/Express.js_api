...
CREATE TABLE IF NOT EXISTS `class` (
    id int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, name varchar(255) NOT NULL, teacher_id int, FOREIGN KEY (teacher_id) REFERENCES teacher (id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
INSERT INTO
    `teacher` (
        id, office, type_of_employment
    )
VALUES (2, 'A-101', 'Full-time');
...
INSERT INTO
    `tutorials` (
        title, description, published, author_id
    )
VALUES (
        'Tutorial 1', 'Description 1', true, 1
    );
...
VALUES (
        'Tutorial 2', 'Description 2', true, 1
    );
...
VALUES (
        'Tutorial 3', 'Description 3', true, 1
    );
